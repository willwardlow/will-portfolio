  ...
  return (
    <div className='about-container'>
      ...
      <div className='about-text'>
        ...
        <p className='p4'>
          Recently, I finished General Assembly's Software Engineeering Immersive program. I learned skills ranging from front-end development, back-end development, computer science and algorithms.
        </p>
      </div>
    </div>
  )
